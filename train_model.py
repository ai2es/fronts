...
Last updated: 7/20/2021 3:13 PM CDT
"""
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __data_generation(self):
        ...
        std_devs = [21.161467, 20.603729, 9590.54, 5.587448, 4.795126, 24.325, 12.2499125, 0.175, 24.675, 20.475,
            ...
            8.122294976, 6.424827792, 1313.379508, 0.005520186, 16.7592906, 7.689928269, 6.445098408, 1178.610181,
...
def train_new_unet(front_files, variable_files, map_dim_x, map_dim_y, learning_rate, train_epochs, train_steps,
                   ...
                   workers, job_number, model_dir, front_types, normalization_method, fss_mask_size):
    """
    ...
    train_dataset = tf.data.Dataset.from_generator(DataGenerator, args=[front_files, variable_files, map_dim_x,
        map_dim_y, train_batch_size, train_fronts, front_types, normalization_method], output_types=(tf.float32,
        tf.float32))

    validation_dataset = tf.data.Dataset.from_generator(DataGenerator, args=[front_files, variable_files, map_dim_x,
        map_dim_y, valid_batch_size, valid_fronts, front_types, normalization_method], output_types=(tf.float32,
        tf.float32))
...
def train_imported_unet(front_files, variable_files, learning_rate, train_epochs, train_steps, train_batch_size,
    ...
    front_types, normalization_method, fss_mask_size):
    """
    ...
    if args.import_model_number is not None:
        if args.map_dim_x is not None or args.map_dim_y is not None:
            ...
            train_imported_unet(front_files, variable_files, args.learning_rate, args.train_epochs, args.train_steps,
                args.train_batch_size, train_fronts, args.valid_steps, args.valid_batch_size, args.valid_freq,
                valid_fronts, args.loss, args.workers, args.import_model_number, args.model_dir, args.front_types,
                args.normalization_method, args.fss_mask_size)
    else:
        ...
        if args.map_dim_x is None or args.map_dim_y is None:
            ...
            train_new_unet(front_files, variable_files, args.map_dim_x, args.map_dim_y, args.learning_rate,
                args.train_epochs, args.train_steps, args.train_batch_size, train_fronts, args.valid_steps,
                args.valid_batch_size, args.valid_freq, valid_fronts, args.loss, args.workers, args.job_number,
                args.model_dir, args.front_types, args.normalization_method, args.fss_mask_size)
