...
def UNet_3plus_3d(map_dim_x, map_dim_y, num_classes):
    ...
    print("kernel size: %dx%dx%d" % (kernel_size[0], kernel_size[1], kernel_size[2]))
    print("strides: (%d,%d,%d)" % (strides[0], strides[1], strides[2]))
    ...
    En1De5 = MaxPooling3D(pool_size=(16,16,1))(x)
...
def UNet_3plus_3d_no_En1_skip(map_dim_x, map_dim_y, num_classes):
    """
    Creates a 3-dimensional U-Net 3+.
